                        ...
                        <div class="table-responsive table-borderless" id="table-background">
                            <table class="table">
                                <thead class="table table-bordered">
                                    <tr>
                                        <th class="job_table">Title</th>
                                        <th class="job_table">Job Title</th>
                                ...
                                <tbody>
                                    <tr class="table-row">
                                        <td id="img-div" class="table-data"></td>
                                        <td>
                                            <div></div>
                                            <div class="row">
                                                <div class="col">
                                                    <h6><strong>Category: </strong>Photography</h6>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col">
                                        ...
                                        <td class="table-data">Published</td>
