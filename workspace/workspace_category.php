...
//                }
    ...
    if(isset($_GET['c_id'])){
        ...
        $query="SELECT * FROM job_post WHERE category_id={$cat_id}  ORDER BY createdAt DESC ";
...
<?php  }
            ...
            echo "<br><br><br><br><h4 class='uk-text-center'><strong>No Results for this category</strong></h4><br><br><br><br><br><br><br>";
        }
