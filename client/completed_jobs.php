            ...
            <div class="container-fluid d-flex flex-column p-0">
                ...
                <ul class="nav navbar-nav text-light" id="accordionSidebar">
                    <li class="nav-item" role="presentation"><a class="nav-link" href="index.php"><i class="fas fa-tachometer-alt"></i><span><strong>Dashboard</strong></span></a><a class="nav-link" href="../profile_page/client_profile_page.php?p_id=<?php echo $_SESSION['user_id'];?>"><i class="fas fa-user"></i><strong>Profile</strong></a>
                            ...
                            <a class="nav-link active" href="completed_jobs.php"><i class="fas fa-paper-plane"></i><span><strong>Completed Jobs</strong><br></span></a>
                    ...
                    <div class="table-responsive follow-tbody">
                        <table class="table">
                           ...
                           <?php
                            ...
                            $query="SELECT * FROM jobs_applied WHERE client_id= {$_SESSION['user_id']} AND job_progress='completed' ORDER BY apply_date DESC";
...
<!--                                        <a href="completed_jobs.php?job_post_id=<?php echo $job_post_id; ?>&f_id=<?php echo $freelancer_id; ?>"><i class="fas fa-check"></i></a>-->
