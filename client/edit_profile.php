        ...
        <nav class="navbar navbar-dark fixed-top align-items-start sidebar sidebar-dark accordion bg-gradient-primary p-0" id="sidebar">
            <div class="container-fluid d-flex flex-column p-0">
                ...
                <ul class="nav navbar-nav text-light" id="accordionSidebar">
                    <li class="nav-item" role="presentation"><a class="nav-link" href="index.php"><i class="fas fa-tachometer-alt"></i><span><strong>Dashboard</strong></span></a><a class="nav-link active" href="../profile_page/client_profile_page.php?p_id=<?php echo $_SESSION['user_id'];?>"><i class="fas fa-user"></i><strong>Profile</strong></a>
                       ...
                       <?php
                        ...
                        if(isset($_POST['submit'])){
                            ...
                            //invocation of updateClientProfile method
                             updateClientProfile($user_id,$firstname,$lastname,$address,$contact_number,$dob,$job_title,$gender, $description, $link, $tags,$profile_image); 
                       ...
                       <form action="" method="post" enctype="multipart/form-data">
                        <div class="form-row">
                            ...
                            <div class="col-md-6 offset-md-0" id="forms">
                                ...
                                <input class="form-control" type="text" name="job_title" value="<?php echo $job_title; ?>">
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="form-row" id="form-adjust">
                                <div class="col">
                                    <div class="form-group">
                                    <input type="file" name="image" src="assets/img/dogs/<?php echo $image; ?>">
                                    </div>
                                </div>
                            </div>
                        </div>
