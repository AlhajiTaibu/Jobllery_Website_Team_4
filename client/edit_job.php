        ...
        <nav class="navbar navbar-dark fixed-top align-items-start sidebar sidebar-dark accordion bg-gradient-primary p-0" id="sidebar">
            <div class="container-fluid d-flex flex-column p-0">
                ...
                <ul class="nav navbar-nav text-light" id="accordionSidebar">
                    <li class="nav-item" role="presentation"><a class="nav-link" href="index.php"><i class="fas fa-tachometer-alt"></i><span><strong>Dashboard</strong></span></a><a class="nav-link" href="profile.php"><i class="fas fa-user"></i><strong>Profile</strong></a>
                        ...
                        <a
                            class="nav-link" href="notification.php"><i class="fas fa-info"></i><span><strong>Notification</strong></span></a><a class="nav-link" href="messages.php"><i class="fas fa-envelope-open"></i><span><strong>Messages</strong></span></a>
                            <a
...
<?php include "includes/navigation.php";?>
            <div class="container-fluid profile">
                <div class="profile-container">
                    <h3 class="header"><strong>Update Job</strong></h3>
                      <?php
                            if(isset($_GET['p_id'])){
                       ...
                       <?php
                        ...
                        updateJob($job_post_id,$client_id,$category,$title,$contract,$description,$deadline,$required_skill,$min_salary, $max_salary,$salary_type,$tags,$offered_salary,$duration,$experience,$profile_image,$location);
                       ...
                       <form action="" method="post" enctype="multipart/form-data">
                        <div class="form-row">
                            <div class="col-md-6 offset-md-0" id="forms">
                                ...
                                <label>Title</label>
                                <input class="form-control" type="text" placeholder="Job Title" name="job_title" value="<?php echo $job_title; ?>">
                            ...
                            <div class="form-row" id="form-adjust">
                                <div class="col">
                                   <label>Description</label>
                                    <div class="form-group">
                                    <textarea class="form-control" rows="10" cols="30" name="description"><?php echo $job_description; ?></textarea>
                        ...
                        <div class="form-group">
                            <div class="form-row" id="form-adjust">
                                <div class="col">
                                   ...
                                   <img width="100" src="assets/img/dogs/?php echo $image; ?>" alt="">
                                    <div class="form-group">
                        ...
                        <div class="form-row">
                            <div class="col-md-6 offset-md-0" id="forms">
                               ...
                               <!--  if the job category field is empty alert user-->
                                ...
                                <input class="form-control" type="tel" placeholder="Node.js,Java,Photoshop,Video editing" name="required_skill" value="<?php echo $required_skills; ?>">
                            ...
                            <input class="form-control" type="text" placeholder="eg. $2,000" name="max_salary" value="<?php echo $max_salary; ?>">
                            </div>
                            <div class="form-group">
                            <label>Tags</label>
                            <input class="form-control" type="text" placeholder="eg. PHP, HTML" name="tags" value="<?php echo $tags; ?>">
                             <!--  if the tags field is empty alert user-->
                                <p class="text small text-danger"><?php echo isset($error['tags']) ? $error['tags']:''; ?></p>
                            </div>
                             <div class="form-group">
                            <label>Job Duration</label>
                            <input class="form-control" type="text" placeholder="" name="duration" value="<?php echo $job_duration; ?>">
                        ...
                        <div class="col-md-6 offset-md-0" id="forms">
                            ...
                            <input class="form-control" type="text" placeholder="eg. $100" name="min_salary" value="<?php echo $min_salary; ?>">
                            </div>
                            <div class="form-group">
                            ...
                            <select class="form-control" name="offered_salary" required>
            ...
            <div class="form-group" id="forms">
                <div class="form-row">
                    <div class="col">
                        <div class="form-group">
                        <button class="btn btn-primary" id="button" type="submit" name="submit">Update Job</button>
                        </div>
                    </div>
                    <div class="col">
